        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfLeague = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WinRate = table.Column<double>(type: "double precision", nullable: false, defaultValue: 0.0),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    LeagueNumber = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score1 = table.Column<double>(type: "double precision", nullable: false, defaultValue: 0.0),
                    Score2 = table.Column<double>(type: "double precision", nullable: false, defaultValue: 0.0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MatchRoundId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MatchId = table.Column<int>(type: "integer", nullable: false),
